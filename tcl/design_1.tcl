...
\
  ...
  set_property -dict [list \
    CONFIG.C_RX_FIFO_PE_THRESHOLD {12} \
    CONFIG.C_RX_FIFO_PF_THRESHOLD {500} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins full_radio_0/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins axi_fifo_mm_s_0/S_AXI]

  # Create port connections
  connect_bd_net -net axi_iic_0_gpo [get_bd_pins axi_iic_0/gpo] [get_bd_pins lowlevel_dac_intfc_0/resetn]
  connect_bd_net -net full_radio_0_m_axis_tdata [get_bd_pins full_radio_0/m_axis_tdata] [get_bd_pins lowlevel_dac_intfc_0/data_word] [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tdata] [get_bd_pins system_ila_0/SLOT_0_AXIS_tdata]
  connect_bd_net -net full_radio_0_m_axis_tvalid [get_bd_pins full_radio_0/m_axis_tvalid] [get_bd_pins lowlevel_dac_intfc_0/valid] [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tvalid] [get_bd_pins system_ila_0/SLOT_0_AXIS_tvalid] [get_bd_pins axi_fifo_mm_s_0/axi_str_rxd_tlast]
  ...
  connect_bd_net -net s00_axi_aclk_0_1 [get_bd_ports clk125] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins full_radio_0/s00_axi_aclk] [get_bd_pins lowlevel_dac_intfc_0/clk125] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins system_ila_0/clk] [get_bd_pins xpm_cdc_gen_0/dest_clk] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins rst_clk125_125M/slowest_sync_clk]
  connect_bd_net -net xpm_cdc_gen_0_dest_rst_out [get_bd_pins xpm_cdc_gen_0/dest_rst_out] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins full_radio_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins system_ila_0/resetn] [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn]
